...
public class CatalogList {
	...
	public void create(CatalogEntry catalogEntry) {
		try {
			...
			// Only when under offline mode, product_id is chosen here as the largest id + 1.
			// On the other hand, under the online mode, product_id is generated by the server.
			if (catalogEntry.get_product_id().equals("-1")) {
